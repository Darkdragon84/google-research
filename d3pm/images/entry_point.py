...
def main(executable_dict, argv):
    ...
    if FLAGS.experiment_dir:
        work_unit.create_artifact(
            platform.ArtifactType.DIRECTORY, FLAGS.experiment_dir, "experiment_dir"
        )
    if FLAGS.work_unit_dir:
        work_unit.create_artifact(
            platform.ArtifactType.DIRECTORY, FLAGS.work_unit_dir, "work_unit_dir"
        )
    logging.info(
        "experiment_dir=%s work_unit_dir=%s", FLAGS.experiment_dir, FLAGS.work_unit_dir
    )
